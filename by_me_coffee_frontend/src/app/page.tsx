...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex gap-6">
          ...
          <Button
            ...
            className="py-6 text-lg font-semibold rounded-3xl cursor-pointer hover:bg-yellow-300 bg-yellow-300 text-black"
          >
            Sign up
          </Button>
        </div>
      ...
      <Button
        onClick={() => router.push("/sign-up")}
        className="rounded-full flex items-center justify-center h-24 text-24 px-20 mt-1 cursor-pointer bg-yellow-300"
      >
      ...
      <div className="mt-24 flex flex-col max-w-[1140px] w-full gap-6">
        ...
        <div className="w-290">
          <div className="mb-20 flex items-center flex-col">
            <h2 className="mt-32 text-center text-dark w-3/4 font-bold text-6xl text-64">
              {" "}
            ...
            <div className="mt-30 grid grid-cols-2 flex-wrap gap-x-20 w-4/5 gap-y-20  ">
              <div className="flex">
                ...
                <h3 className="text-24 font-semibold text-2xl text-gray-400">
                  We dont call them customers or transactions. They are your
              ...
              <div className="flex">
                <CircleCheck width={100} height={100} />
                <h3 className="text-24 text-center  font-semibold text-2xl text-gray-400">
                  You have <p>100% ownership</p> of your supporters. We never
                  email them, and you can export the list any time you like.
                </h3>
              </div>
              <div className="flex">
                <CircleCheck width={100} height={100} />
        ...
        <div className="bg-white rounded-[48px] w-full text-center p-12 px-24 ">
          <h2 className="animated-content mt-24 text-dark font-bold text-6xl">
            {" "}
            Make 20% or more,
            <p className="text-gray-500 font-bold text-6xl">
          ...
          <div className="grid grid-cols-3 gap-y-30 gap-x-30 mt-20">
            <div className="text-left">
              ...
              <h3 className="text-dark text-20 font-bold text-xl mt-1 mb-4">
                Not just a membership
              </h3>
              <h4 className="text-gray-400 text-20 font-bold text-xl">
                Creators who previously only used Patreon noticed a massive
                increase in earnings after accepting one-off payments.
              </h4>
            </div>
            <div className="text-left">
              ...
              <h4 className="text-gray-400 text-20 font-bold text-xl">
                We now support Spanish, French, Italian, German and
                Ukrainian—making it easier for your global audience to support
                you.
              </h4>
            </div>
            <div className="text-left">
              ...
              <h4 className="text-gray-400 text-20 font-bold text-xl">
                Instead of paying separately for email marketing tools like
                Mailchimp, send unlimited emails to your fans for free.
              </h4>
            </div>
            <div className="text-left">
              ...
              <h4 className="text-gray-400 text-20 font-bold text-xl">
                ICYMI, we make it simple and fun for your supporters. While you
                cannot put a number on feelings, it tends to show on the
                results.
              </h4>
            </div>
            <div className="text-left">
        ...
        <div className="pb-10 mt-10">
          <div className="flex w-290">
            <div className="text-16 flex items-center mr-16 font-semibold text-sm text-gray-500">
              {" "}
              © Buy Me a Coffee{" "}
            </div>
            <div className="flex w-full justify-center">
              <p className="text-dark font-bold mr-15 flex items-center text-sm ">
                About
              </p>
              <p className="text-dark font-bold mr-15 flex items-center text-sm">
                Help center

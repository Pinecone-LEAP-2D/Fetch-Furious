    ...
    <div className="flex w-[510px] h-auto flex-col gap-[24px]">
      ...
      <div className="flex flex-col gap-[12px]">
        <div className="flex w-[510px] h-[62px] gap-[8px]">
          ...
          <Input
            className="flex px-8 py-12 h-[24px] items-center w-[486px] font-normal text-sm"
            placeholder="Enter your name here"
          />
        </div>
        <div className="flex w-[510px] h-[62px] gap-[8px] mt-[50px]">
          <label className="font-semibold text-sm">About</label>
          <Input
            className="flex px-8 py-12 h-[131px] items-center w-[486px] font-normal text-sm"
            placeholder="Write about yourself here"
          />
        </div>
        <div className="flex w-[510px] h-[62px] gap-[8px] mt-[80px]">
      ...
      <div className="flex  gap-[10px] w-[510px] mt-[30px]">
        <Button onClick={()=>setStep('bankCard')} className="flex w-[246px] h-[40px] px-8 py-16 justify-center items-center gap-[8px]">
            Continue
        </Button>
      </div>
    </div>

    ...
    <div className="max-w-[800px] rounded-xl">
      <div className="flex flex-col  max-w-[800px] border p-4 m-2 rounded-sm">
        <div className="flex justify-between">
          <div className="flex items-center ">
            <img src={profile?.avatarImage ? profile.avatarImage : '/next.svg'}
      ...
      <div className=" border p-5 max-w-[800px] rounded-sm">
        <div className="flex items-center  justify-between">
          <div className="flex items-center">
            <p className="rounded-full w-10 h-10 px-4 bg-gray-200 text-center flex items-center justify-center">
              CN
            </p>
            <div className=" px-2">
              <p>Guest</p>
